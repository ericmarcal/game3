...
namespace InteliMapPro
{
    public class TilemapTool : EditorTool, IDrawSelectedHandles
    {
        ...
        {
            // << CORRIGIDO: Substituído pelo método compatível com Unity 2020 >>
            icon = new GUIContent(AssetPreview.GetMiniThumbnail(target));
        }
        ...
        public void OnDrawHandles()
        {
            if (isDragging || forceDraw)
            {
                ...
                // A linha abaixo foi comentada em uma etapa anterior para evitar erros.
                // Se você tiver o script TileSelectionHandles e ele funcionar, pode descomentar.
